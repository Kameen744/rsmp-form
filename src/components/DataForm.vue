    ...
    <form @submit.prevent="submitForm" ref="mainFormRef">
      ...
      <div class="form-step" :class="{ active: currentStep === 2 }">
        ...
        <div class="mb-3">
          ...
          <div class="invalid-feedback d-block" v-if="err('Status_of_support')">
        ...
        <div class="mb-3">
          ...
          <div class="invalid-feedback d-block" v-if="err('Level_of_support')">
        ...
        <div v-if="formData.Level_of_support.includes('LGA')" class="mb-3 mt-3">
          <label class="typo__label">
                ...
                <div class="d-flex justify-content-between">
                  <div class="form-check">
                    <input
                      ...
                      @change="toggleThematicAreaLevel(theme.area, 'National')"
                    />
                    <label
